...
namespace NKRY_API.Migrations
{
    ...
    [Migration("20230930124542_EditFinanceToDecimalMigration")]
    partial class EditFinanceToDecimalMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NKRY_API.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Property<Guid?>("EmployeeFinanceId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NKRY_API.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("NKRY_API.Domain.Entities.EmployeeFinance", "EmployeeFinance")
                        .WithMany()
                        .HasForeignKey("EmployeeFinanceId1");
